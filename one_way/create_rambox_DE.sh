...
declare -r absolute_hdd_icon_path="/media/alfredo/Backup/CONFIG_LINUX/scripts/one_way/resources/rambox.png";
...
if [ "$choise" == "y" ]; then
    ...
    result=0;
    sudo cp $absolute_hdd_icon_path $1 &> $null;
    if [ $? == 1 ]; then
        sudo cp $absolute_hdd_icon_path $1;
